using ModelingToolkit, MethodOfLines, OrdinaryDiffEq, DomainSet, Plots

# Automated efficient solution to nonlinear partial differential equation. The first approach is the ModelingToolkit.jl
